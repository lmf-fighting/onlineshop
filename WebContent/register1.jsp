				...
				<table width="1200" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						<td class="padding-top"><img alt="收藏"
							...
							<a href="login.jsp" style="font-weight: 700; color: #f60;">[请登录]</a>
							<a href="register1.jsp" style="font-weight: 700; color: #f60;">[免费注册]</a>
						</td>
						<td align="right">客户服务<img alt="arrow"
							...
							height="18">&nbsp; <span class="droparrow"> <span
								class="shopcart"></span>我的购物车 <span class="orange"></span>件<img
	...
	<table width="1200px" border="0" cellspacing="0" cellpadding=0
		...
		<tr>
			<td height="95"><a href=" "><img
					src="photo/index/banner2.jpg" style="position: center;"
					width="100%" height="180"></a></td>
		</tr>
	</table>

	<!-- 菜单导航 -->
	<table width="1200px" align="center" border="0"
		style="line-height: 38px;" cellspacing="0" cellpadding="0"
		bgcolor="#FF3030">
		<tr>
			<td>
				<table width="1200" border="0" cellspacing="0" cellpadding="4"
					...
					<tr>
						...
						<td width="100" align="center"><a href="shoppingShow.jsp"
							class="white">最新上架</a></td>
								...
								<table width="90%" border="0" cellspacing="0" cellpadding="0"
									...
									<tr>
										...
										<td><input name="userName" type="text"
											style="width: 400px; height: 38px; border: 2px solid #FA8072;"
									...
									<tr>
										...
										<td><input name="userPwd"
											style="width: 400px; height: 38px; border: 2px solid #FA8072;"
											type="password" onpropertychange="userPwd.innerHTML=''">&nbsp;
											<b><span id="userPwd" style="color: red"></span></b></td>
									</tr>
									...
									<tr>
										...
										<td><input type="file"
											style="border: 2px solid #FA8072; background: #fff;"
									...
									<tr>
										...
										<td><select id="cmbProvince" name="cmbProvince"
											style="height: 38px; border: 2px solid #FA8072;"></select> <select
											id="cmbCity" name="cmbCity"
											style="height: 38px; border: 2px solid #FA8072;"></select> 
											<select
											id="cmbArea" name="cmbArea"
											style="height: 38px; border: 2px solid #FA8072;"
											onpropertychange="selectAddress.innerHTML=''">&nbsp;
												</b>
												<span id="selectAddress" name="selectAddress" style="color: red"></span>
												</b>
										</select> <input name="address" onpropertychange="address.innerHTML=''"
											type="text"
											style="width: 250px; height: 38px; border: 2px solid #FA8072;"
											placeholder="详细地址">&nbsp; <b><span id="address"
												style="color: red"></span></b> 
												<script type="text/javascript">
													addressInit('cmbProvince',
															'cmbCity',
															'cmbArea');
												</script></td>
									</tr>
									...
									<tr>
										...
										<td><textarea rows="4" cols="40"
												style="border: 2px solid #FA8072;"></textarea></td>
									</tr>
									...
									<tr>
										...
										<td style="height: 50px;"><input type="button"
											style="background: #fff; height: 30px; width: 80px; border: 2px solid #FA8072;"
											name="b_submit" onclick="register_submit()" value="提交" /></td>
									</tr>
								</table>
							</form>
						</td>
