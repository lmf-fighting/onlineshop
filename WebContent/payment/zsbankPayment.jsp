...
<html>
    ...
    <body>
     ...
     <%@ include  file ="../top.jsp" %>
    		...
    		<table id='div1' border="1" width="700" height="200" rules="none" style="margin-top:120; position: absolute; left: 250px; top: 150px;">
				  <%
				 ...
				 <tr>
				 	<td style="padding-left:100">
				 		...
				 		请立即支付：<input type="button" value="确认支付" onclick="showPay()" style="width: 60px;height: 40px;">
				 	</td>
				 </tr>				
    		</table>
    		<div id='div2'
		...
		<form action="" method="post">
			<table border="1" bordercolor="lightgrey" bgcolor="#F9F9F9"
				...
				<tr>
					<td style="padding-left: 100;">输入密码：<input type="password" id="password" style="width:300px;height: 40px;"  >
