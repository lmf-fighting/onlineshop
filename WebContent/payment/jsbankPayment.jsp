...
<html>
  ...
  <%@ include  file ="../top.jsp" %>
    	...
    	<div id='div1'
		style="background: url(); width: 720; height: 60; position: absolute; left: 250px; top: 50px;">
   			<form action="" method="post">
    		<table border="1" bordercolor="lightgrey" bgcolor="#F9F9F9" width="700" height="200" height="200" rules="none" cellpadding="0" cellspacing="0" style="margin-top:230">
				 <tr>
				  <%
                  ...
                  %>
				 	<td style="padding-left:100">
				 		...
				 		请立即支付：<input type="button" style="width: 60px;height: 40px;" value="确认支付"  onclick="showPay()"><br><br>
				 	</td>
				 </tr>				
    		</table>
   			</form>
    	...
    	<div id='div2'
		style="background: url(); width: 720; height: 10; position: absolute; left: 300px; display: none;">
		<form action="" method="post">
