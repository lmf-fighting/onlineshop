...
<body>
 ...
 <!-- 顶部区域start -->
	...
	<div id='div1'
		style="background: url(); width: 720; height: 10; position: absolute; left: 200px; top: 50px;">
			...
			<table border="1" bordercolor="lightgrey" bgcolor="#F9F9F9"
				...
				<tr>
					<td style="padding-left: 100">订单号：<font color="red">${param.orderid}</font>，您需要支付：<font
						...
						你选择的是通过通过银行转帐进行网上支付，只有在网上支付成功后，我们才会为您发货。 <br> 请立即支付：<input
						type="button" value="确认支付" onclick="showPay()">
					</td>
				</tr>
			</table>
		</form>
	...
	<div id='div2'
		style="background: url(); width: 720; height: 10; position: absolute; left: 250px; display: none;">
		<form action="" method="post">
			<table border="1" bordercolor="lightgrey" bgcolor="#F9F9F9"
				width="600" height="200" rules="none" cellpadding="0"
				cellspacing="0" style="margin-top: 230">
